...
def work(bdStr, saveFilePath, isSyncBdOnly, isSkipPlot):
    ...
    if isSyncBdOnly:
        ...
        # 设置祝福
        data["savedItems"] = [{"itemData":"","data":[2,34,1,0,128,255,255,255,0,0,0],"inventoryPosition":{"x":0,"y":0},"quantity":1,"containerID":33,"formatVersion":2},{"itemData":"","data":[2,34,24,0,128,255,255,255,0,0,0],"inventoryPosition":{"x":0,"y":0},"quantity":1,"containerID":34,"formatVersion":2},{"itemData":"","data":[2,34,47,0,128,255,255,255,0,0,0],"inventoryPosition":{"x":0,"y":0},"quantity":1,"containerID":35,"formatVersion":2},{"itemData":"","data":[2,34,128,0,128,255,255,255,0,0,0],"inventoryPosition":{"x":0,"y":0},"quantity":1,"containerID":36,"formatVersion":2},{"itemData":"","data":[2,34,73,0,128,255,255,255,0,0,0],"inventoryPosition":{"x":0,"y":0},"quantity":1,"containerID":37,"formatVersion":2},{"itemData":"","data":[2,34,137,0,128,255,255,255,0,0,0],"inventoryPosition":{"x":0,"y":0},"quantity":1,"containerID":38,"formatVersion":2},{"itemData":"","data":[2,34,151,0,128,255,255,255,0,0,0],"inventoryPosition":{"x":0,"y":0},"quantity":1,"containerID":39,"formatVersion":2},{"itemData":"","data":[2,34,173,0,128,255,255,255,0,0,0],"inventoryPosition":{"x":0,"y":0},"quantity":1,"containerID":43,"formatVersion":2},{"itemData":"","data":[2,34,199,0,128,255,255,255,0,0,0],"inventoryPosition":{"x":0,"y":0},"quantity":1,"containerID":44,"formatVersion":2},{"itemData":"","data":[2,34,205,0,128,255,255,255,0,0,0],"inventoryPosition":{"x":0,"y":0},"quantity":1,"containerID":45,"formatVersion":2}]
        for i in range(10):
            if str(i + 1) in bd["blessing"].keys():
                bless_id = bd["blessing"][str(i + 1)]
                data["savedItems"][i]["data"] = [2, 34, bless_id, 0, 128, 255, 255, 255, 0, 0, 0]
        # 设置职业
